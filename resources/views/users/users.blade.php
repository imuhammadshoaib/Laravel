    ...
    <div class="flex flex-col justify-center h-full">
        ...
        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header class="p-6 bg-white border-b border-gray-200">
                <h2 class="font-semibold text-gray-800">Users Details</h2>
            </header>
            <div class="p-3">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium ">{{ $user->role->name }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium">{{ $user->is_active ? 'Active' : 'Inactive' }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
