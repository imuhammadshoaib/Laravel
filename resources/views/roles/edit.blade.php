            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="mt-10 sm:mt-0">
                    <header class="p-6 bg-white border-b border-gray-200" style="margin-bottom:15px;">
                        <h2 class="font-semibold text-gray-800">Edit Role Details</h2>
                    </header>
                    <div class="w-full">
                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" value="{{$role->name}}" name="name" autocomplete="name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select name="is_active" id="" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                                                    @foreach($statuses as $key => $value)
                                                        <option value="{{ $key }}" {{ ( $key == $role->is_active) ? 'selected' : '' }}>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
                                                </select>
